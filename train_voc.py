...
parser.add_argument("--n_gpu", type=str, default='2', help="number of cpu threads to use during batch generation")
...
train_dataset = VOCDataset(root_dir='BCCD_Dataset-master/BCCD',resize_size=[800,1333],
...
for epoch in range(EPOCHS):
    for epoch_step, data in enumerate(train_loader):
        ...
        optimizer.zero_grad()
        # print([batch_imgs, batch_boxes, batch_classes])
    ...
    torch.save(model.state_dict(),
               "./checkpoint/vovnet_model_{}.pth".format(epoch + 1))
