...
class GenTargets(nn.Module):
    ...
    def forward(self, inputs):
        '''
        inputs[0]   list [cls_logits,cnt_logits,reg_preds]
...
def compute_cnt_loss(preds, targets, mask):
    # print(preds[0].shape)  # torch.Size([8, 1, 104, 136])
    # print(preds[1].shape)  # torch.Size([8, 1, 52, 68])
    # print(preds[2].shape)  # torch.Size([8, 1, 26, 34])
    # print(preds[3].shape)  # torch.Size([8, 1, 13, 17])
    # print(preds[4].shape)  # torch.Size([8, 1, 7, 9])
    # print(targets.shape)  # torch.Size([8, 18848, 1])
    """14144 + 3536 + 884 + 221 + 63 = 18848"""
    # print(mask.shape)   # torch.Size([8, 18848])
    '''
    Args  
...
if __name__ == "__main__":
    ...
    cnt_loss = compute_cnt_loss([
        torch.ones([8, 1, 124, 136]),
        torch.ones([8, 1, 62, 68]),
        torch.ones([8, 1, 31, 34]),
        torch.ones([8, 1, 16, 17]),
        torch.ones([8, 1, 8, 9])
                             ],

        torch.ones([8, 22478, 1])
        ,
    ...
    reg_loss = compute_reg_loss(
        [
            torch.ones([8, 4, 124, 136]),
            torch.ones([8, 4, 62, 68]),
            torch.ones([8, 4, 31, 34]),
            torch.ones([8, 4, 16, 17]),
            torch.ones([8, 4, 8, 9])
        ],

        torch.ones([8, 22478, 4])
        ,
    ...
    cls_loss = compute_cls_loss(
        [
            torch.ones([8, 3, 124, 136]),
            torch.ones([8, 3, 62, 68]),
            torch.ones([8, 3, 31, 34]),
            torch.ones([8, 3, 16, 17]),
            torch.ones([8, 3, 8, 9])
        ],

        torch.ones([8, 22478, 3])
        ,
