...
from .backbone.vovnet import vovnet57
...
class FCOS(nn.Module):
    ...
    def forward(self,x):
        ...
        import numpy as np
        # print(np.array(all_P).shape)  # list
        # print(all_P)
        # [tensor1 ,tensor2, tensor3, tensor4, tensor5]
        # print(all_P[0].size())  # torch.Size([8, 256, 104, 136])
        # print(all_P[1].size())  # torch.Size([8, 256, 52, 68])
        # print(all_P[2].size())  # torch.Size([8, 256, 26, 34])
        # print(all_P[3].size())  # torch.Size([8, 256, 13, 17])
        # print(all_P[4].size())  # torch.Size([8, 256, 7, 9])
